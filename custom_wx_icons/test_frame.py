...
from wx_icons_suru import wxSuruIconTheme  # type: ignore[import-untyped]
from wx_icons_tango import wxTangoIconTheme  # type: ignore[import-untyped]

__all__ = ["IconWallApp", "TestFrame"]
